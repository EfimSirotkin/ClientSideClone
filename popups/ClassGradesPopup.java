...
public class ClassGradesPopup {
    ...
    public void generateLayout(String selectedDirectory) {
        ...
        applyButton.setOnAction(actionEvent -> {
            ...
            ClassGradesExporter classGradesExporter = new ClassGradesExporter();
            try {
                classGradesExporter.exportTemplate(selectedDirectory + "\\Экспорт-"+  selectedClass + ".xls", selectedClass);
            } catch (IOException e) {
                e.printStackTrace();
